      ...
      <Sider theme="light" width={200}>
        ...
        >
          ...
          <Menu.Item key="/drivers" icon={<CarOutlined />}>
            <Link to="/drivers" className="text-gray-600">Drivers</Link>
          </Menu.Item>
          <Menu.Item key="/assign-orders" icon={<ScheduleOutlined />}>
            <Link to="/assign-orders" className="text-gray-600">Assign Orders</Link>
          </Menu.Item>
          <Menu.Item key="/profile" icon={<UserOutlined />}>
            <Link to="/profile" className="text-gray-600">Profile</Link>
          </Menu.Item>
          <Menu.Item key="/analytics" icon={<BarChartOutlined />}>
            <Link to="/analytics" className="text-gray-600">Analytics</Link>
          </Menu.Item>
        </Menu>
      </Sider>
      <Layout>
