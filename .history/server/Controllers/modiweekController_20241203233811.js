const Modiweek = require("../Models/modiweek.js");

const getCurrentModiweek = async (req, res) => {
  try {
...
const createModiweek = async (req, res) => {
  try {
...
const updateModiweek = async (req, res) => {
  try {
    const { id } = req.params;
...
module.exports = { getCurrentModiweek, createModiweek, updateModiweek };
